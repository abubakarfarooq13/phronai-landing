...
export const networkMenuItems = [
  ...
  {
    id: 5,
    label: "Devs Dashboard",
    href: "https://devs.phron.ai/",
    icon: <FiSettings fontSize="20px" color="#321b7a" />,
    target: "_blank",
  },
  // {
  //   id: 5,
  ...
  // },
  {
    ...
    icon: "/assets/faucet-icon-new.svg",
    target: "_blank",
    noStyle: true,
  },
  // {
  ...
  // },
  {
    ...
    icon: <FaLink fontSize="20px" color="#321b7a" />,
    isComingSoon: false,
    target: "_blank",
  },
  {
    ...
    icon: <FiBarChart2 fontSize="22px" color="#321b7a" />,
    isComingSoon: false,
    target: "_blank",
  },
];
...
export const communityMenuItems = [
  ...
  },
  {
    ...
    icon: <MdWifiTethering fontSize="22px" color="#321b7a" />,
    target: "_blank",
  },
  {
    id: 11,
    label: "Phrony",
    href: "/phrony",
    icon: "/assets/phrony-icon-new.svg",
    // target: "_blank",
    noStyle: true,
  },
];
