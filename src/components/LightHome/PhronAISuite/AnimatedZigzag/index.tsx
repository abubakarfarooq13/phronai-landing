...
const moveAlongPath = keyframes`
  ...
  33.34% { transform: translate(0, 80px) rotate(-13deg); }
  66.66% { transform: translate(-86px, 100px) rotate(-13deg); }
...
export default function SharpZigzagAnimation() {
  return (
    <Box position="relative" w="90px" h="180px" overflow="hidden">
      ...
      />
      <Box position="absolute" top="98px" left="0" w="4px" h="82px" bg="gray.200" />
