          ...
          boxShadow="0 0px 50px -12px rgba(0, 0, 0, 0.1)"
            >
              <Box p="20px" height={{base:"350px",lg:"300px"}}>
                ...
                <Text fontSize={{base:"14px",md:"16px",lg:"17px"}} mt="20px" color="#666c88">
                  {" "}
            ...
            >
              ...
              <Box w="full" p="20px">
                ...
                <Text mt="10px" fontSize={{base:"14px",md:"16px",lg:"17px"}} color="#666c88">
                  Gathering all the major vendors 
                  of AI Models and developments in a single place.
                </Text>
              </Box>
              <Flex h="full"  alignItems={{base:"center",md:"end",lg:"end"}}  w={{base:"full",md:"100%"}} maxW="180px">
              <Image src="/assets/open-phron/libraries0.png" alt="openphron" height="1000" width="1000"/>
              </Flex></Flex>
            </GridItem>
            <GridItem
            ...
            ><Flex flexDir={{base:"column",md:"row"}}  justifyContent={{base:"center",md:"space-between"}} alignItems="center">
              <Box p="20px">
                ...
                <Text fontSize={{base:"14px",md:"16px",lg:"17px"}} mt="10px" color="#666c88">
                  Monetize your AI Smart Contracts 
                  without jeopardizing your intellectual 
                  property.
                </Text>
              </Box> <Flex display={{base:"block",md:"none"}} overflow="hidden"  alignItems={{base:"center",md:"end"}}  w={{base:"160px",md:"full"}}  maxW="210px">
              <Image src="/assets/open-phron/robot0.png" alt="openphron" height="1000" width="1000"/>
              </Flex>
              <Flex display={{base:"none",md:"block"}} overflow="hidden"  alignItems={{base:"center",md:"end"}}  w={{base:"160px",md:"full"}}  maxW="160px">
              <Image src="/assets/open-phron/subscription0.png" alt="openphron" height="1000" width="1000"/>
              </Flex>
              </Flex>
            </GridItem>
            <GridItem
            ...
            >
              ...
              <Image src="/assets/open-phron/ringup.png" alt="openphron" height="1000" width="1000"/>
              </Flex>
              <Box zIndex="10" p="20px">
                ...
                <Text fontSize={{base:"14px",md:"16px",lg:"17px"}} mt="10px" color="#666c88">
                  ...
                  organizations,
                  projects <Box display={{base:"none",md:"none",lg:"block"}}  as="span"></Box>and universities for a collaborative<Box display={{base:"block",md:"none"}}  as="span"></Box> progress of AI
                  technology in Blockchain.
                </Text>
              </Box>
              <Flex ml={{base:"-150px"}} mb={{base:"0px",md:"-80px"}} display={{base:"block",md:"none",lg:"none"}}  alignItems={{base:"center",md:"start"}}  w={{base:"150px",}}  maxW="530px">
              <Image src="/assets/open-phron/ringdown.png" alt="openphron" height="1000" width="1000"/>
              </Flex>
              ...
              <Flex mr={{md:"-60px"}} mt={{md:"-80px"}} display={{base:"none",md:"block",lg:"none"}}  alignItems={{base:"center",md:"start"}}  w={{base:"full",}}  maxW="530px">
              <Image src="/assets/open-phron/ringup.png" alt="openphron" height="1000" width="1000"/>
              </Flex></Flex>
            </GridItem>
          </Grid></Fade>
